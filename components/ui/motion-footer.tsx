...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    ...
    <span>Workflow Automation</span> <span className="text-secondary/60">✦</span>
    <span>AI Integration</span> <span className="text-primary/60">✦</span>
    <span>n8n &amp; APIs</span> <span className="text-secondary/60">✦</span>
